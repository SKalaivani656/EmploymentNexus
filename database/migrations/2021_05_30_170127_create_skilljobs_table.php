...
class CreateSkilljobsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('skilljobs', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('postjob_skilljob', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('skilljobs');
        Schema::dropIfExists('postjob_skilljob');
    }
}
