...
class CreateTagjobsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tagjobs', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('postjob_tagjob', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tagjobs');
        Schema::dropIfExists('postjob_tagjob');
    }
}
