...
class CreateTypejobsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('typejobs', function (Blueprint $table) {
            $table->id();

            $table->string('name')->unique()->index();
            $table->string('shortname')->unique()->index();
            $table->integer('schemaorg_type');
        ...
        Schema::create('postjob_typejob', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('typejobs');
        Schema::dropIfExists('postjob_typejob');
    }
}
