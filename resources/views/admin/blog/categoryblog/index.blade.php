...
<x-admin.layouts.adminbreadcrumb>
 ...
 <x-admin.layouts.adminindex>
    ...
    <x-slot name="action">
        @can('categoryblog-create')
        <a class="btn btn-sm btn-primary shadow float-end" href="{{ route('categoryblog.create') }}" role="button">Create</a>
       @endcan
    </x-slot>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#ajaxcategoryblog').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        "ajax": {
            "url": '{!! route('categoryblog.index') !!}',
