...
<x-admin.layouts.adminbreadcrumb>
 ...
 <x-admin.layouts.adminindex>
    ...
    <x-slot name="action">
    @can('coursejob-create')
        <a class="btn btn-sm btn-primary shadow float-end" href="{{ route('coursejob.create') }}" role="button">Create</a>
    @endcan
    </x-slot>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#ajaxcourse').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        "ajax": {
            "url": '{!! route('coursejob.index') !!}',
...
<script>
  ...
  $("#coursejob").css({"background-color": "#00c5d0"});
