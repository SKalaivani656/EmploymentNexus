...
<x-admin.layouts.adminbreadcrumb>
 ...
 <x-admin.layouts.adminindex>
    ...
    <x-slot name="action">
    @can('designationjob-create')
        <a class="btn btn-sm btn-primary shadow float-end" href="{{ route('designationjob.create') }}" role="button">Create</a>
    @endcan
    </x-slot>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#ajaxdesignation').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        "ajax": {
            "url": '{!! route('designationjob.index') !!}',
