<div class="col-md-2">
    {!! Form::checkbox('active', null, isset($companyjob) ? $companyjob->active : 0, ['id' => 'branchactive', 'class' => 'form-check-input']) !!}
    @include('helper.formlabel', ['id'=>'', 'for' => "branchactive", 'name' => "ACTIVE", 'required' => false])
    @include('helper.formerror', ['error' => "active"])
</div>
<div class="col-md-1">
    {!! Form::checkbox('is_top', null, isset($companyjob) ? $companyjob->is_top : 0, ['id' => 'branchistop', 'class' => 'form-check-input']) !!}
    @include('helper.formlabel', ['id'=>'', 'for' => "branchistop", 'name' => "IS TOP", 'required' => false])
    @include('helper.formerror', ['error' => "is_top"])
</div>
<div class="col-md-1">
    {!! Form::checkbox('is_image', null, isset($companyjob) ? $companyjob->is_image : 0, ['id' => 'is_image', 'class' => 'form-check-input']) !!}
    @include('helper.formlabel', ['id'=>'', 'for' => "is_image", 'name' => "IMAGE", 'required' => false])
    @include('helper.formerror', ['error' => "is_image"])
</div>
<div class="col-md-2">
    {!! Form::checkbox('is_popular', null, isset($companyjob) ? $companyjob->is_popular : 0, ['id' => 'branchispopular', 'class' => 'form-check-input']) !!}
    @include('helper.formlabel', ['id'=>'', 'for' => "branchispopular", 'name' => "IS POPULAR", 'required' => false])
    @include('helper.formerror', ['error' => "is_popular"])
</div>
<div class="col-md-2">
    {!! Form::checkbox('is_footer', null, isset($companyjob) ? $companyjob->is_footer : 0, ['id' => 'branchisfooter', 'class' => 'form-check-input']) !!}
    @include('helper.formlabel', ['id'=>'', 'for' => "branchisfooter", 'name' => "IS FOOTER", 'required' => false])
    @include('helper.formerror', ['error' => "is_footer"])
</div>
<div class="col-md-2">
    {!! Form::checkbox('is_leftsidemenu', null, isset($companyjob) ? $companyjob->is_leftsidemenu : 0, ['id' => 'branchisleftsidemenu', 'class' => 'form-check-input']) !!}
...
<div class="col-md-2">
    {!! Form::checkbox('is_mobile', null, isset($companyjob) ? $companyjob->is_mobile : 0, ['id' => 'branchismobile', 'class' => 'form-check-input']) !!}
    @include('helper.formlabel', ['id'=>'', 'for' => "branchismobile", 'name' => "IS MOBILE", 'required' => false])
    @include('helper.formerror', ['error' => "is_mobile"])
</div>
<div class="col-md-9">
    @include('helper.formlabel', ['id'=>'titleLeft', 'for' => "company", 'name' => "COMPANY NAME", 'required' => true])
    {{ Form::text('name', $companyjob->name, ['id' => 'company', 'maxlength' => '70', 'class' => 'form-control']) }}
    @include('helper.formerror', ['error' => "name"])
</div>
<div class="col-md-3">
    @include('helper.formlabel', ['id'=>'', 'for' => "position", 'name' => "POSITION", 'required' => false])
    {{ Form::text('position', $companyjob->position, ['id' => 'position', 'class' => 'form-control', 'readonly' => 'readonly']) }}
...
<div class="col-md-6">
    ...
    => true])
    {{ Form::text('shortname', $companyjob->shortname, ['id' => 'shortname', 'maxlength' => '20', 'class' => 'form-control']) }}
    @include('helper.formerror', ['error' => "shortname"])
</div>

<div class="col-md-6">
    @include('helper.formlabel', ['id'=>'', 'for' => "websiteurl", 'name' => "WEBSITE URL", 'required'
    => true])
    {{ Form::text('websiteurl', $companyjob->websiteurl, ['id' => 'websiteurl', 'maxlength' => '80', 'class' => 'form-control']) }}
    @include('helper.formerror', ['error' => "websiteurl"])
</div>
...
<div class="col-md-12">
    ...
    'required' => true])
    {{ Form::textarea('seo_description', $companyjob->seo_description, ['id' => 'description', 'maxlength' => '200', 'class' => 'form-control', 'rows' => '2']) }}
    @include('helper.formerror', ['error' => "seo_description"])
</div>
<div class="col-md-12">
    @include('helper.formlabel', ['id'=>'', 'for' => "remarks", 'name' => "REMARK", 'required' => false])
    {{ Form::textarea('remarks', $companyjob->remarks, ['id' => 'remarks', 'class' => 'form-control', 'rows' => '2']) }}
