...
<x-admin.layouts.adminshow>
    ...
    <x-slot name="label">
       ...
       @include('helper.showlabel', ['name' => "MOBILE", 'value' => isset($websiteenquiry) && ($websiteenquiry->is_mobile== 0)  ? 'NO' : 'YES' , 'columnone' => "col-md-6", 'columntwo' => "col-4", 'columnthree' => "col-8"])
        ...
        @include('helper.showlabel', ['name' => "PHONE", 'value' => $websiteenquiry->phone, 'columnone' => "col-md-6", 'columntwo' => "col-4", 'columnthree' => "col-8"])
        @include('helper.showlabel', ['name' => "EMAIL", 'value' => $websiteenquiry->email, 'columnone' => "col-md-6", 'columntwo' => "col-4", 'columnthree' => "col-8"])
        @include('helper.showlabel', ['name' => "MESSAGE", 'value' => $websiteenquiry->message, 'columnone' => "col-md-6", 'columntwo' => "col-4", 'columnthree' => "col-8"])
        @include('helper.showlabel', ['name' => "TYPE", 'value' => $websiteenquiry->type, 'columnone' => "col-md-6", 'columntwo' => "col-4", 'columnthree' => "col-8"])
        @include('helper.showlabel', ['name' => "NOTE", 'value' => $websiteenquiry->note, 'columnone' => "col-md-6", 'columntwo' => "col-4", 'columnthree' => "col-8"])
