...
@section('adminnavbar')
    <x-admin.layouts.adminnavbar modulename="KEY CONFIGURATION" />
@endsection
...
<x-admin.layouts.admincreateorupdate>
    ...
    <x-slot name="form">
    {!! Form::model($adminconfigurationkey, ['route' => ['adminconfigurationkey.store', $adminconfigurationkey->id],  'id' => '', 'class' => ' form_prevent_multiple_submits ', 'novalidate' => 'novalidate', 'files' => 'true','enctype'=>'multipart/form-data']) !!}
       {{ Form::hidden('id', $adminconfigurationkey->id, array('id' => 'invisible_id')) }}

    @include('admin.settings.configuration.adminconfigurationkey.form') 

    <div class="text-center mt-3">
    @if ($adminconfigurationkey->id)
