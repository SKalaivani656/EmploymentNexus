...
namespace App\Http\Controllers\Admin\Web\Settings\Role;
            ...
            return DataTables::of($role)
                ->addColumn('action', function ($role) {
                    ...
                    if (auth()->user()->can('role-show')) {
                        $action .= '<a href="role/' . $role->id . '" class="shadow rounded btn btn-sm btn-success"><i class="bi bi-eye-fill"></i></a>';
                    }
                    if (auth()->user()->can('role-edit')) {
                        $action .= ' <a href="role/' . $role->id . '/edit" class="shadow rounded btn btn-sm btn-primary"><i class="bi bi-pencil-square"></i></a>';
                    }
                    $action .= ' </td>';
                    return $action;
                })
